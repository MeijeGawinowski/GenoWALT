        ...
        for qtl in range(N_qtl):
            ...
            if nb == 2:
                ...
                for k in range(len(arr)):
                    ...
                    subdict[str(arr_elt)] = meanval_list
            ...
            if len(list(listGeno.values())[0]) != N_qtl:
                ...
                for ind in range(N_ind):
                    ...
                    for qtl in range(N_qtl):
                        ...
                        nb_allel = data[qtl,6]
                        subdict[qtl] = list(np.random.choice(list(range(nb_allel)),size=2,replace=True))
    ...
    def getQTLtab(self,popGeno,data):
        ...
        for i in range(N_ind):
            ...
            for j in range(N_qtl):
                ...
                try :
                    idx = list_allel.index(str(allel)) # allele indice in the list
                except ValueError :
