...
export(init_pop,format="genepop",adjust=1,output="Tests/HW/size100/Controlled_Reproduction/allo1/pop0.txt")
for g in range(1,N_gen):
	...
	namefile = "Tests/HW/size100/Controlled_Reproduction/allo1/pop"+str(g)+".txt"
