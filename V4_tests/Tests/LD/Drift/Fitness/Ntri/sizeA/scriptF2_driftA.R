...
setwd("~/Documents/LD_Tests/Drift/Fitness/Ntri/sizeA/Rep1")
...
setwd("~/Documents/LD_Tests/Drift/Fitness/Ntri/sizeA/Rep2")
vect_r2 <- c()
...
setwd("~/Documents/LD_Tests/Drift/Fitness/Ntri/sizeA/Rep3")
vect_r3 <- c()
...
setwd("~/Documents/LD_Tests/Drift/Fitness/Ntri/sizeA/Rep4")
vect_r4 <- c()
...
setwd("~/Documents/LD_Tests/Drift/Fitness/Ntri/sizeA/Rep5")
vect_r5 <- c()
...
write.table(newdata_A,"~/Documents/LD_Tests/Drift/Fitness/Ntri/tabA.csv")
