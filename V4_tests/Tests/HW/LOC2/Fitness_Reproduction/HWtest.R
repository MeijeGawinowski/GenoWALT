...
rm(list=ls())
library(genepop)
setwd("~/Documents/GenoWALT/V4_tests/Tests/HW/LOC2/Fitness_Reproduction/allo0")
...
rm(list=ls())
setwd("~/Documents/GenoWALT/V4_tests/Tests/HW/LOC2/Fitness_Reproduction/allo0.5")
pval1 <- c()
SE1 <- c()
WC1 <- c()
...
rm(list=ls())
setwd("~/Documents/GenoWALT/V4_tests/Tests/HW/LOC2/Fitness_Reproduction/allo1")
pval1 <- c()
SE1 <- c()
WC1 <- c()
